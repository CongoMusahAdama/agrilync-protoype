...
const Index = () => {
  ...
  const investmentPackages = [
    {
      name: 'Starter',
      investment: 'GHΓé╡ 1,500 ΓÇô 3,000',
      farmers: '3ΓÇô5 farmers',
      bestFor: 'NGOs, CSR programs, small impact funds',
      term: 'Single season',
      return: 'Revenue-share of 15ΓÇô20% of net harvest value',
    ...
    {
      name: 'Growth',
      investment: 'GHΓé╡ 3,000 ΓÇô 7,000',
      farmers: '10ΓÇô20 farmers',
      bestFor: 'MFIs, banks, mid-size impact funds',
      term: 'Single or dual season',
      return: 'Revenue-share of 18ΓÇô25% of net harvest value, plus impact-linked incentives',
    ...
    {
      name: 'Portfolio',
      investment: 'GHΓé╡ 10,000+',
      farmers: '40ΓÇô100+ farmers',
