...
const { getFarmers, getFarmerById, addFarmer, updateFarmer, getPendingFarmersByRegion, registerFarmerPublic, getFlaggedFarmers, resolveFlag, sendBulkSms } = require('../controllers/farmerController');
